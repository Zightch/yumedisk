...
typedef struct _YUMEDISK_EVENT_SLOT_DESCRIPTOR {
    UINT64 SessionId;
    UINT64 SlotId;
    UINT32 TargetId;
    UINT32 Reserved0;
    ...
    UINT32 Capacity;
    UINT32 Flags;
} YUMEDISK_EVENT_SLOT_DESCRIPTOR, *PYUMEDISK_EVENT_SLOT_DESCRIPTOR;

typedef struct _YUMEDISK_SUBMIT_EVENT_SLOT {
    YUMEDISK_EVENT_SLOT_DESCRIPTOR Slot;
} YUMEDISK_SUBMIT_EVENT_SLOT, *PYUMEDISK_SUBMIT_EVENT_SLOT;

#define YUMEDISK_SUBMIT_EVENT_SLOT_BASE_SIZE sizeof(YUMEDISK_SUBMIT_EVENT_SLOT)
#define YUMEDISK_SUBMIT_EVENT_SLOT_SIZE() YUMEDISK_SUBMIT_EVENT_SLOT_BASE_SIZE
