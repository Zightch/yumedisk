...
impl ProtocolStatusCode {
    pub fn code(self) -> u16 {
        match self {
            ...
            Self::ErrInvalidRequestId => 0x1004,
            ...
            Self::ErrSessionNotFound => 0x1201,
            Self::ErrSessionExpired => 0x1202,
            Self::ErrSessionClosed => 0x1203,
    ...
    pub fn from_u16(value: u16) -> Self {
        match value {
            ...
            0x1004 => Self::ErrInvalidRequestId,
            ...
            0x1201 => Self::ErrSessionNotFound,
            0x1202 => Self::ErrSessionExpired,
            0x1203 => Self::ErrSessionClosed,
